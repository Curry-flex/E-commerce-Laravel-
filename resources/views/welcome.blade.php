...
<head>
	...
	<link href="{{asset('/frontend/css/owl.carousel.css')}}" >
	<link href="{{asset('/frontend/css/owl.theme.default.css')}}" >
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-4">
						...
						<h1 class="text-primary"><span>E</span>-SELL</h1>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="{{url('/cart')}}"><i class="fa fa-shopping-cart"></i> Cart <span class="badge badge-danger">{{Cart::count()}}</span></a></li>
							...
							<div class="item active">
								<?php } else {?>
									<div class="item ">
										<?php } ?>
								<div class="col-sm-4">
									<h1><span>E</span>-SELL</h1>
									<h2></h2>
									<p>We sell different product around the world with huge discount your request our service </p>
